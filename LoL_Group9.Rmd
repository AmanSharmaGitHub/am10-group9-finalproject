...
<<<<<<< HEAD
# LR huge model
regression_lol5 <- glm(blue_wins ~ blue_first_blood + avg_level_diff + kill_diff + wards_diff + elite_diff + dragon_diff + heralds_diff + towers_diff + cs_diff + jg_diff + blue_KDA + red_KDA, data=clean_lol_data, family = "binomial")
...
plot1 <- ggplot(plot_log, aes(x=avg_level_diff)) +
  ...
  NULL
plot1
>>>>>>> e63dbbef476dc03d7cb7b1bc7a3662d90eae6762
```
