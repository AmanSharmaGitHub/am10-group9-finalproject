...
model_linear_gold <- lm(blue_gold_diff ~ blue_first_blood + avg_level_diff + kill_diff + wards_diff + elite_diff + dragon_diff + heralds_diff + towers_diff + cs_diff + jg_diff + blue_KDA + red_KDA, data = clean_lol_data)
summary(model_linear_gold)

model_linear_exp <- lm(blue_experience_diff ~ blue_first_blood + avg_level_diff + kill_diff + wards_diff + elite_diff + dragon_diff + heralds_diff + towers_diff + cs_diff + jg_diff + blue_KDA + red_KDA, data = clean_lol_data)
