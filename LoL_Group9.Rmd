...
League of Legends is a popular game. According to LeagueFeed, it had over 100 million players in 2020.
However, many of our team were not very familiar with the game and this made the process of storytelling and turning data into valuable insight quite challenging, especially if our audience is those who are highly knowledgable and skilled at the game. One benefit of this situation though is that most of us would be quite unbiased when it comes to recommending a game strategy because we do not have personal anecdotal experience that may influence which conclusions we wish to draw.
Moreover, we obtained this dataset from Kaggle and some cleaning had already been done. While this was helpful for us, it also meant we have less transparency and understanding of the original dataset and must have faith in the integrity of whoever uploaded it.
...
>>>>>>> 6de09a3216d7d1ad4b9660baa8003e3f183dda9d
...
```{r}
clean_lol_data %>% group_by(blue_kills) %>%
  summarise(prop_wins=(count(blue_wins=1)/(count(blue_wins=1)+count(blue_wins=0))))
